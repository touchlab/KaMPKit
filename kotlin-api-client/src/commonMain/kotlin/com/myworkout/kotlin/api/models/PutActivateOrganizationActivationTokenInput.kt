 ...
 * 
 * @param permissions 
 * @param departmentUuid The department that the user should join
 */
@Serializable
data class PutActivateOrganizationActivationTokenInput (
    @SerialName(value = "permissions") val permissions: kotlin.collections.List<DataPermission>? = null,
    /* The department that the user should join */
    @SerialName(value = "departmentUuid") val departmentUuid: kotlin.String? = null
)
