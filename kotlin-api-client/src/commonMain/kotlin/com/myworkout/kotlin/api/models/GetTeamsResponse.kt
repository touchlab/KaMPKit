...
import com.myworkout.kotlin.api.models.GetTeamsResponseMeta
import com.myworkout.kotlin.api.models.Team
...
data class GetTeamsResponse (
    @SerialName(value = "data") val data: kotlin.collections.List<Team>? = null,
    @SerialName(value = "meta") val meta: GetTeamsResponseMeta? = null
)
