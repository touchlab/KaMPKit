...
/**
 * 
 * @param next URL to continue to connect administrator user with the organization
 */
@Serializable
data class CreateOrganizationResponseLink (
    /* URL to continue to connect administrator user with the organization */
