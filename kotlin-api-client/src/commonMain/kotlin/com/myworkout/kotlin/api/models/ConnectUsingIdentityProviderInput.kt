...
/**
 * 
 * @param subjectToken The ID token of the subject that should be exchanged for access tokens
 */
@Serializable
data class ConnectUsingIdentityProviderInput (
    /* The ID token of the subject that should be exchanged for access tokens */
    @SerialName(value = "subject_token") val subjectToken: kotlin.String? = null
)
