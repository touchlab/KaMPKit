...
import com.myworkout.kotlin.api.models.OrganizationInviteResponse
 ...
 */
@Serializable
data class OrganizationInviteCollectionResponse (
    @SerialName(value = "data") val data: kotlin.collections.List<OrganizationInviteResponse>? = null
)
