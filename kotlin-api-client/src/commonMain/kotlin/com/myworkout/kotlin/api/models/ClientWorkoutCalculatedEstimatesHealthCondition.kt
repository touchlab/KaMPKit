...
import com.myworkout.kotlin.api.models.ClientWorkoutCalculatedEstimatesHealthConditionParameters
 ...
 */
@Serializable
data class ClientWorkoutCalculatedEstimatesHealthCondition (
    @SerialName(value = "vo2max") val vo2max: kotlin.Double? = null,
    @SerialName(value = "biological_age") val biologicalAge: kotlin.Int? = null,
    @SerialName(value = "parameters") val parameters: ClientWorkoutCalculatedEstimatesHealthConditionParameters? = null
)
