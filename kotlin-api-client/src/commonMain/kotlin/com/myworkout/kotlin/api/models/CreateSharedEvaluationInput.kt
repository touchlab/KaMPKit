 ...
 */
@Serializable
data class CreateSharedEvaluationInput (
    @SerialName(value = "vo2max") @Required val vo2max: kotlin.Int,
    @SerialName(value = "biological_age") @Required val biologicalAge: kotlin.Int,
    @SerialName(value = "workout_uuid") @Required val workoutUuid: kotlin.String
)
