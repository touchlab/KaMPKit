...
import com.myworkout.kotlin.api.models.VideoCollectionResponsePaging
import com.myworkout.kotlin.api.models.VideoResponse
...
data class VideoCollectionResponse (
    @SerialName(value = "paging") @Required val paging: VideoCollectionResponsePaging,
    @SerialName(value = "data") @Required val data: kotlin.collections.List<VideoResponse>
)
