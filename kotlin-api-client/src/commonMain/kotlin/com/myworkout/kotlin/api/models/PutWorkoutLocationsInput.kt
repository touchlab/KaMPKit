...
import com.myworkout.kotlin.api.models.Location
 ...
 */
@Serializable
data class PutWorkoutLocationsInput (
    @SerialName(value = "data") @Required val data: kotlin.collections.List<Location>
)
