...
import com.myworkout.kotlin.api.models.TeamMembers
 ...
 */
@Serializable
data class GetUserTeamMembersResponse (
    @SerialName(value = "data") val data: kotlin.collections.List<TeamMembers>? = null
)
