...
import com.myworkout.kotlin.api.models.PrivacyConsentState
 ...
 */
@Serializable
data class PrivacyConsentsResponse (
    @SerialName(value = "data") val data: kotlin.collections.List<PrivacyConsentState>? = null
)
