 ...
 */
@Serializable
data class CreateContestInput (
    @SerialName(value = "name") @Required val name: kotlin.String,
    /* iso8601 */
    @SerialName(value = "start_at") @Required val startAt: kotlin.String,
    /* iso8601 */
    @SerialName(value = "finish_at") @Required val finishAt: kotlin.String,
    @SerialName(value = "visibility") @Required val visibility: CreateContestInput.Visibility,
