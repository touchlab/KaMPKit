...
import com.myworkout.kotlin.api.models.HeartRate
 ...
 */
@Serializable
data class PutWorkoutHeartRatesInput (
    @SerialName(value = "data") @Required val data: kotlin.collections.List<HeartRate>
)
