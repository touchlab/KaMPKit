...
import com.myworkout.kotlin.api.models.UserActivityProgress
 ...
 */
@Serializable
data class GetUserActivityProgressResponse (
    @SerialName(value = "data") val data: UserActivityProgress? = null
)
