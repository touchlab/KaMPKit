...
import com.myworkout.kotlin.api.models.FeedActivity
 ...
 */
@Serializable
data class GetFeedActivitiesResponse (
    @SerialName(value = "data") val data: kotlin.collections.List<FeedActivity>? = null
)
