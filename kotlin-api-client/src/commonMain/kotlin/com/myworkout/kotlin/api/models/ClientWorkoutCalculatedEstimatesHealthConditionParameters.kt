...
/**
 * Parameters used to calculate vo2max
 * @param speed 
 * @param incline 
 * @param watt 
 * @param bodyWeight 
 */
@Serializable
data class ClientWorkoutCalculatedEstimatesHealthConditionParameters (
    @SerialName(value = "speed") val speed: kotlin.Double? = null,
    @SerialName(value = "incline") val incline: kotlin.Double? = null,
    @SerialName(value = "watt") val watt: kotlin.Double? = null,
