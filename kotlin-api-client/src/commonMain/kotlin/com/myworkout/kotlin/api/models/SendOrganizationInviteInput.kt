...
/**
 * 
 * @param inviteId ID of invitation to re-send
 */
@Serializable
data class SendOrganizationInviteInput (
    /* ID of invitation to re-send */
    @SerialName(value = "inviteId") @Required val inviteId: kotlin.Int
)
