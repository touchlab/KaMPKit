...
import com.myworkout.kotlin.api.models.TeamContest
 ...
 */
@Serializable
data class GetTeamContestsResponse (
    @SerialName(value = "data") val data: kotlin.collections.List<TeamContest>? = null
)
