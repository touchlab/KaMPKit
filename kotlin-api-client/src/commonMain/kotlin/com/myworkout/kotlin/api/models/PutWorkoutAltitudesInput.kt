...
import com.myworkout.kotlin.api.models.Altitude
 ...
 */
@Serializable
data class PutWorkoutAltitudesInput (
    @SerialName(value = "data") @Required val data: kotlin.collections.List<Altitude>
)
