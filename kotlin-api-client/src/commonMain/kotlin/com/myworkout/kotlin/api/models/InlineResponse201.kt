...
import com.myworkout.kotlin.api.models.InlineResponse201Meta
...
data class InlineResponse201 (
    @SerialName(value = "data") val data: Device? = null,
    @SerialName(value = "meta") val meta: InlineResponse201Meta? = null
)
