...
import com.myworkout.kotlin.api.models.OrganizationDepartmentMemberRole
...
/**
 * 
 * @param memberId OrganizationUser id
 * @param role 
 */
@Serializable
data class CreateOrganizationDepartmentMemberInput (
    /* OrganizationUser id */
    @SerialName(value = "member_id") val memberId: kotlin.Int? = null,
    @SerialName(value = "role") val role: OrganizationDepartmentMemberRole? = null
)
