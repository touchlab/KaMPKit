...
import com.myworkout.kotlin.api.models.InlineResponse2011Meta
...
data class InlineResponse2011 (
    @SerialName(value = "data") val data: UserSubscription? = null,
    @SerialName(value = "meta") val meta: InlineResponse2011Meta? = null
)
