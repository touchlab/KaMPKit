...
/**
 * 
 * @param phone e.164 compliant phone number that the invite should be sent to
 */
@Serializable
data class SendTeamInviteAsSmsInput (
    /* e.164 compliant phone number that the invite should be sent to */
