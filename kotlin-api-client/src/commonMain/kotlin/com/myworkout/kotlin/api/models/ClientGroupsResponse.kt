...
import com.myworkout.kotlin.api.models.ClientGroup
 ...
 */
@Serializable
data class ClientGroupsResponse (
    @SerialName(value = "data") val data: kotlin.collections.List<ClientGroup>? = null
)
