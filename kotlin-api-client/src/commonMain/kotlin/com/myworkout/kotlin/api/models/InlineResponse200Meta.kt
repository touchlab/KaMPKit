...
import com.myworkout.kotlin.api.models.InlineResponse200MetaLinks
 ...
 * 
 * @param links 
 * @param onboardingText Custom text that should be displayed during onboarding
 */
@Serializable
data class InlineResponse200Meta (
    @SerialName(value = "links") val links: InlineResponse200MetaLinks? = null,
    /* Custom text that should be displayed during onboarding */
