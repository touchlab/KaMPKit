...
import com.myworkout.kotlin.api.models.ClientGroupMember
 ...
 */
@Serializable
data class ClientGroupMembersResponse (
    @SerialName(value = "data") val data: kotlin.collections.List<ClientGroupMember>? = null
)
