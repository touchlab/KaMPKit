...
import com.myworkout.kotlin.api.models.NotificationInput
 ...
 */
@Serializable
data class PatchNotificationsInput (
    @SerialName(value = "data") @Required val data: kotlin.collections.List<NotificationInput>
)
