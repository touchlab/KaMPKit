...
import com.myworkout.kotlin.api.models.GroupResponse
 ...
 */
@Serializable
data class GetOrganizationGroupsResponse (
    @SerialName(value = "data") val data: kotlin.collections.List<GroupResponse>? = null
)
