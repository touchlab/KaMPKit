...
/**
 * 
 * @param publicLeaderboard URL to a public leaderboard if it is enabled
 */
@Serializable
data class ContestResponseLinks (
    /* URL to a public leaderboard if it is enabled */
    @SerialName(value = "public_leaderboard") val publicLeaderboard: kotlin.String? = null
)
