...
of KMP would take some time, but KaMP Kit is focused on native mobile development, so we'll speak to that specifically.
...
KMP is a new tech, supporting many features and platforms, and has had rapid development over the past 2-3 years. As a 
...
* Jetbrains: Jetbrains has built an amazing business on building the best IDEs. They also make Kotlin the language. This is a unique combination. They are self-funded, as in there is no VC or public shareholder pressure to have 
